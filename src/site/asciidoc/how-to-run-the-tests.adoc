...
As entry point the Landing Page of the OGC API - Processes Standard 1.0 is expected.
...
`java -jar ets-ogcapi-processes10-0.1-SNAPSHOT-aio.jar [-o|--outputDir $TMPDIR] [test-run-props.xml]`
